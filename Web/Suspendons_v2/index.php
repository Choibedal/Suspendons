...
<section id="intro" class="wrapper style1 featured">
	<div class="inner">
		...
		<div class="content">
			...
			<footer>
				<ul class="actions">
					<li><a href="don.php" class="button big">Je fais un don</a></li>
				</ul>
			</footer>
		</div>
	</div>
...
<!-- One -->
<section class="wrapper style2 texte">
	<div class="inner">
		<header>
			<h2>Contexte :</h2>
			<p>
			...
			<p>
				Ce projet a vu le jour à l’occasion du « <a href="http://switchupchallenge.com" title="Lien vers le Switch Up Challenge" target="_blank" rel="nofollow">Switch UP Cisco Challenge</a> », un concours de projets entrepreneurials sociaux lancé en septembre
				2016. Notre projet a déjà séduit certains professionnels du monde entrepreneurial, puisque nous avons été qualifiés pour les phases finales du concours, et sommes actuellement soutenus, suivis et conseillés par des experts au sein de l’entreprise
				CISCO.
			</p>
		</header>
		<footer>
			<ul class="actions">
				<li><a href="concept.php" class="button big">En savoir plus</a></li>
			</ul>
		</footer>
	</div>
</section>
...
<section class="wrapper style1 special">
	<div class="inner">
		<header>
			<h2>Un sans-abris a besoin d'aide</h2>
			<p>Permettez lui de reprendre confiance et venez lui en aide.</p>
		</header>
		...
		<footer>
			<ul class="actions">
				<li><a href="carte.php" class="button">Carte des services disponibles</a></li>
			</ul>
		</footer>
	</div>
</section>
